...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('user', '0005_remove_user_roles_remove_user_groups_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('kids', 'Kids'), ('admin', 'Admin'), ('psychologue', 'Psychologue'), ('educateur', 'Éducateur')], max_length=20)),
